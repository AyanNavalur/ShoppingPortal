				...
				<table class="table table-hover" id="productList">
					<thead>
						<tr>
							...
							<th>Manufacturer</th>
							<th>
								View <security:authorize ifAnyGranted="ROLE_USER">
										/Add to Cart
									</security:authorize>
					...
					<tbody>
						<tr ng-repeat="b in products | filter:searchCondition">
							<td style="width: 171px;"><img src='<c:url value="../resource/images/products/{{b.productId}}.jpg" />' style="width: 100px; height: 90px;" {{b.productName}} ></td>
							<td>{{b.productId}}</td>
							...
							<td>
								<a href="getProductById/{{b.productId}}"
								class="btn btn-info" role="button"> <span class="glyphicon glyphicon-info-sign"></span></a>
								<security:authorize ifAnyGranted="ROLE_USER">
									<a href="#" ng-click="addToCart(${b.productId})" class="btn btn-primary"
										style="margin-left: 5px"> <span class="glyphicon glyphicon-shopping-cart"></span></a>
								</security:authorize>
								<security:authorize ifAnyGranted="ROLE_ADMIN">
									<a href="admin/product/editProduct/{{b.productId}}"
										class="btn btn-success" style="margin-left: 5px"> <span class="glyphicon glyphicon-edit"></span></a>
									<a href="admin/delete/{{b.productId}}" class="btn btn-danger"
										style="margin-left: 5px"> <span class="glyphicon glyphicon-trash"></span></a>
								</security:authorize>
							</td>
						</tr>
					</tbody>

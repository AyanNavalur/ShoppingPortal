					...
					<div class="form-bottom contact-form">
						...
						<form:form role="form" method="post" action="${url}" commandName="contact">
							...
							<div class="form-group">
								...
								<form:input type="text" path="subject" class="contact-subject form-control" placeholder="Subject..." required="required" />
							</div>
							<div class="form-group">
								<label class="sr-only" for="contact-message">Message</label>
								<form:textarea path="message" class="contact-message form-control" placeholder="Message..." required="required" />
							</div>
							<button type="submit" class="btn">Send message</button>
							<button style="float: right;" type="button" class="btn"
								onclick="window.location.href='<c:url value="/index" />'">Cancel</button>
						</form:form>
					</div>
				</div>
			</div>

	...
	<footer class="footer-distributed">
		...
		<div class="footer-left">
			<p class="footer-links">
				<a href="<c:url value="/index1"/>">Home</a> . <a href="<c:url value="/aboutus"/>">About Us</a> . <a href="<c:url value="/getAllProducts" />">Product List</a> . <a href="<c:url value="/contactus"/>">Contact Us</a>
			</p>
			
			<p>
				Created by Ayan Navalur ShoppingPortal &copy; 2020
			</p>
		</div>
	</footer>
</body>
